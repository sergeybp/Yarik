...
public class Client extends AbstractServer {
    ...
    private int isNew = 0;
    private boolean beforePost = false;
    private int nowRead = 0;
    private String[] tmpSlices;
    private String filepr = "client.properties1";
    private ArrayList<String> myPosts = new ArrayList<>();
    private ArrayList<Pair<String, String>> myLikes = new ArrayList<>();
    private ArrayList<Pair<String, String>> nowPosts = new ArrayList<>();

    private ArrayList<String> possibleTags = new ArrayList<>();

    private String myName = "";

    private static StandardQuad myQuad = new StandardQuad("CLIE1", "0.0.0.0", 4558, Network.CLIENT.name());
    private StandardQuad mainServer;
    ...
    private void saveProperties(String key, String val) throws IOException {
    ...
    private void register(String name, String otherInfo, String tags) {
        ...
        switch (gotMessage.getMessageType()) {
            ...
            case GET:
                ...
                if (p.size() >= 2) {
                    ...
                    try {
                        saveProperties("last", "" + (nowPosts.size() + 1));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
